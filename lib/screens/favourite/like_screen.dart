...
import '../../controller/like_provider.dart';
      ...
      body: Consumer<LikeProvider>(
        builder: (context, likeProvider, child) {
          List<Planets> likedPlanets = allPlanets
              .where((planet) => likeProvider.likedPlanets.contains(planet.name))
              .toList();
          ...
          return Stack(
            children: [
              ...
              likedPlanets.isEmpty
                  ? const Center(
                child: Text('No Liked Planets...', style: TextStyle(color: Colors.white)),
              )
                  : ListView.builder(
